...
- Solution URL: [Solution URL](https://github.com/nishanth1596/bento-grid)
- Live Site URL: [Live site URL](https://nishanth-bento-grid.netlify.app/)
...
1. Clone this repository:
   ...
   ```bash
   git clone https://github.com/nishanth1596/bento-grid.git
   ```
...
Google Fonts - I used the DM Sans Display font from Google Fonts to style the text.
